...
import MobileSaasProduct from "./MobileSaasProduct";
    ...
    <div className="w-full bg-white">
      ...
      <div className="hidden lg:block">
        <div className="h-[200vh]">
          <section
            ref={sectionRef}
            className="sticky top-0 min-h-[700px] h-[100svh] w-full flex flex-col items-center justify-between overflow-hidden bg-white"
          >
